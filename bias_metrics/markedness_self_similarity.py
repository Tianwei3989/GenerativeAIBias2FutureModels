...
for age in age_labels:
    ...
    age_count_list.append(len(sub_male.index.str.split('/').str[1].str.split('.').str[0].tolist()))
    age_count_list.append(len(sub_female.index.str.split('/').str[1].str.split('.').str[0].tolist()))
